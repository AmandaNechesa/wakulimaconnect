...
if (isset($_SESSION['wakulimaconnectagrovet']) || isset($_COOKIE['wakulimaconnectagrovet'])) {
    ...
    <head>
        ...
        <title>Wakulima connect admins</title>
    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button"
         style="background-color:rgb(68,137,39);font-size:22px;color:rgb(251,249,249);margin-top: 0;">
        <div class="container"><a class="navbar-brand" href="#">WC-VET</a>
            ...
            <div class="collapse navbar-collapse"
                ...
                <span class="navbar-text actions"><a href="logout.php?homepage=true">LOG OUT TO HOME</a>
                    <a
                            class="btn btn-light action-button" role="button" href="logout.php"
                    ...
                    <div class="col-xs-4 col-md-4">
                        <div class="avatar" style="background:#28a745">
                            <div data-bs-hover-animate="swing" class="avatar-bg center"
                                 style="background-image:url(&quot;assets/img/logo.png&quot;);background-color:#f7f5f5;"></div>
                        </div>
                        <input type="file" class="form-control" required name="avatar-file"></div>
                    <div class="col-xs-6 col-md-6" style=""><select class="form-control" name="category"
                        ...
                        <div class="group">
                            <input type="number" required step='any' class="form-control" name='discount'>
                            <span class="highlight"></span>
                            <span class="bar"></span>
    ...
    <section id="works" style="background-image: url('../img/logo.png');>
        <div class="
    ">
            ...
            while ($rows = $resu->fetch(PDO::FETCH_OBJ)) {
                ...
                <div class="pic" style="max-width: 100%;min-height: auto;">
                    <figure>
                        ...
                        <figcaption class="center card-img-overlay" style="text-transform: uppercase">
                            ...
                            <?php
                            $result = $connection->conn->prepare("SELECT * FROM wakulimaconnectagrovetadmins WHERE id=?");
                            $result->execute([$rows->Uploader]);
                            while ($uploader = $result->fetch(PDO::FETCH_OBJ)) {
                                ?>
                                <h4 style="color:red;">UPLOADER:<?php echo $uploader->name; ?></h4>

                                <?php
                            }
                            ?>
                            <h4 style="color:red;">DISCOUNT:<?php echo $rows->discount; ?></h4>
                            <h4><a href="panel.php?id=<?php echo $rows->identifier; ?>">DELETE</a></h4>
