...
if (isset($_POST['name'])) {
    $connection->CustomerSignUp($_POST['name'], $_POST['email'], $_POST['password'], $_POST['password-repeat'], $_SERVER["PHP_SELF"], $_POST['address']);
...
<div>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button"
        ...
        <div class="container"><a class="navbar-brand" href="index.php">WC-VET</a>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <!--                <span class="navbar-text actions"> <a href="login.php" class="login" style="color:rgb(254,254,254);">Log In</a></span>-->
            </div>
        </div>
    </nav>
</div>
...
<div class="register-photo" style="background-color:rgba(241,247,252,0);margin-top:2px;">
    <div class="form-container">
        <div class="image-holder" style="background-image:url(&quot;assets/img/logo.png&quot;);"
             data-bs-hover-animate="rubberBand"></div>
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            <h2 class="text-center" id="header" style="color:#28a745;"><strong>Create</strong> an account.</h2>
            ...
            <div class="form-group"><input class="form-control" required type="text" name="address"
            ...
            <a href="login.php" class="already" style="color:rgb(244,78,68);">You already have an account? Login
                here.</a></form>
    </div>
</div>
