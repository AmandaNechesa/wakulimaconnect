$(document).ready(function () {
    ...
    i.prototype.listen = function () {
        ...
        var i = void 0 === t.target.files ? t.target && t.target.value ? [{name: t.target.value.replace(/^.+\\/, "")}] : [] : t.target.files;
        ...
        if (this.$preview.length > 0 && (void 0 !== n.type ? n.type.match(/^image\/(gif|png|jpeg)$/) : n.name.match(/\.(gif|png|jpe?g)$/i)) && "undefined" != typeof FileReader) {
            var s = new FileReader, a = this.$preview, r = this.$element;
            s.onload = function (t) {
                var s = e("<img>");
    ...
    e.fn.fileinput = function (t) {
        return this.each(function () {
            var n = e(this), s = n.data("bs.fileinput");
            s || n.data("bs.fileinput", s = new i(this, t)), "string" == typeof t && s[t]()
        })
    ...
    $("input.form-control[name=avatar-file]").change(function () {
        ...
        var i = this;
        new FormData($(this)[0]);
        return $(i).find("button[type = submit]").addClass("loading").prop("disabled", !0), t("alert-success", !0), setTimeout(function () {
            $(i).find("button[type = submit]").removeClass("loading").prop("disabled", !1), t("alert-success")
        }, 1e3), !1
    }), $("#profile").delegate("form", "reset", function (e) {
        var i = this;
        new FormData($(this)[0]);
        return $(i).find("button[type = reset]").addClass("loading").prop("disabled", !0), t("alert-danger", !0), setTimeout(function () {
            $(i).find("button[type = reset]").removeClass("loading").prop("disabled", !1), t("alert-danger")
        }, 1e3), !1
    })
}();