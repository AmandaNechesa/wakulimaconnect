        ...
        <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-container">
                        <div class="carousel-content">
                            ...
                            <p>
                                Click <a href="https://www.ventusky.com/">here</a> and search for your location to view the weather forecast  </p>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2>Do only a few things at a time</h2>
                            <p>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2>Free stuff for all leads to success</h2>
                            <p>
                                In open source, we feel strongly that to really do something well, you have to get a lot
                                of people involved.<br> Linus Torvald
                            </p>
                            <a href="post/" class="btn-get-started scrollto">Upload</a>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2>...have fun using the platform....</h2>
                            <p>
                                Come back later and spread the word that the problems of the farmers in this great
                                country , Kenya , have come to an end </p>
                            <a href="post/" class="btn-get-started scrollto">Upload</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row contact-info">
                ...
                <div class="col-md-6">
                    <div class="contact-phone">
                        ...
                        <h3>Phone Number</h3>
                        <p><a href="tel:+155895548855">+254702653268</a></p>
                    </div>
                </div>
