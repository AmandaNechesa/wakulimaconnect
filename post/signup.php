    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="background-color:#28a745
        ...
        <div class="container"><a class="navbar-brand" href="#">Wakulima-connect</a>
            ...
            <div class="collapse navbar-collapse"
                ...
                <span class="navbar-text actions"> <a href="index.php" class="login" style="color:rgb(254,254,254);">Log In</a>
                       </span></div>
        </div>
    </nav>
</div>
...
<div class="register-photo" style="background-color:rgba(241,247,252,0);margin-top:2px;">
    <div class="form-container">
        <div class="image-holder" style="background-image:url(../img/intro-carousel/1.jpg);"
